...
const rows = [
    createData('RDP Cracked', "IN", "Maharashtra Windows 2012/2019 Cracked Fresh, RAM 64.00 GB, NO Blacklist", "10.00", "crackseller"),
    createData('RDP Cracked', "IN", "Maharashtra Windows 2012/2019 Cracked Fresh, RAM 64.00 GB, NO Blacklist", "10.00", "crackseller"),
]
...
const RDPs = props => {
    return (
        ...
        <Card>
            ...
            <CardHeader title="RDPs" sx={{ fontSize: '20px', fontWeight: '600' }}/>
