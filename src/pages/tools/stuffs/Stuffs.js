...
const rows = [
    createData('DriverLicense', "US", "DriverLicense 1974 male US +SELFIE ID", "12.00", "Japhet123"),
    createData('DriverLicense', "UK", "DriverLicense 1965 male Uk=K +SELFIE ID", "12.00", "Japhet123"),
]
...
const Stuffs = props => {
    return (
        ...
        <Card>
            ...
            <CardHeader title="Stuffs" sx={{ fontSize: '20px', fontWeight: '600' }}/>
